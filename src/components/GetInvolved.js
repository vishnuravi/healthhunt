...
export default function GetInvolved() {
    return (
        <div className="container mt-4">
            ...
            <h4 style={{ color: "#00A8E8" }}><u>Health Innovation Challenges</u></h4>
            <br />
            <ul>
                <li>
                    <p className="lead">Example: How might service learning redesign help adopt remote monitoring?</p>
                </li>
            </ul>
            <h4 style={{ color: "#00A8E8" }}><u>Health Innovator Matchmaking</u></h4>
            <br />
            <ul>
                <li>
            ...
            <h4 style={{ color: "#00A8E8" }}><u>Innovation Consultation</u></h4>
            <br />
            <ul>
                <li>
